...
void handleRoot() {
  ...
  String message = "<html><body>" \
         ...
         message +=   "</table>";
         message +=   "<br>";
         message +=   "<script> function transfer(ssid) {document.getElementById('ssid').value = ssid;} </script>";
         ...
         message +=        "></td></tr>";
         message +=         "<tr><td>SSID: </td><td><input type='text' id='ssid' name='ssid' value='";
         ...
         message +=         "<tr><td>Password: </td><td><input type='text' name='password' value='";
         message +=         settings.password;
         message +=         "'> </td></tr>";
         message +=         "<tr><td>mDNS name: </td><td><input type='text' name='name' value='";
         ...
         message +=        "></td></tr>";
         message +=        "<tr><td>Deep sleep time: </td><td><input type='number' name='deepSleepTime' style='width:130px' value='";
         ...
         message +=         "'>sec </td></tr>";
         message +=    "<tr><td>Auto GET host: </td><td><input type='text' name='getHost' value='";
         message +=         settings.host;
         message +=         "' ></td></tr>";
         message +=    "<tr><td>Auto GET url: </td><td><input type='text' name='getUrl' value='";
